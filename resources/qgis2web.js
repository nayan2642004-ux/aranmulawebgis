...
map.getView().fit([8530760.675265, 1038160.221017, 8538722.808609, 1044377.961057], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">ARANMULA WEBGIS</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (512 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This website created using opensoftware<br />Aranmula, a temple town in Kerala, India, is renowned as the cultural capital of Pathanamthitta district. Situated on the banks of the Pampa, it has been a significant pilgrimage centre since ancient times and an important trade post when the river served as the main transport route. Located near Kozhencherry in Pathanamthitta, Aranmula is easily accessible from Chengannur railway station, just 10 km away. Today, it is one of the fastest-growing villages in the region';
            }
